package otus.service.configuration;
...
public class MainConfiguration {
	...
	public CsvParser csvParser(MessageResolver messageResolver) {
		return new DefaultCsvParser(this.filename, messageResolver);
	}
	...
	public QuestionnaireService questionnaireService(QuestionInputScanner scanner, MessageResolver messageResolver) {
		return new QuestionnaireServiceImpl(csvParser(messageResolver).parse(), scanner, messageResolver);
	}
